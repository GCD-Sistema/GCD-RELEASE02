...
public class DistritalBean {
	...
	public void init() {
		...
		this.membrosAgrupadas = new ArrayList<Desbravador>();
		reset();
	}
...
//	public void atualizaMembrosAgrupadas(){
//		EntityManager em = PersistenceUtil.getCurrentEntityManager();
//		DesbravadorDAO dao = new DesbravadorDAO(em);
//		DistritalDAO distDAO = new DistritalDAO(em);
//		
//		Distrital distrital = distDAO.findByLogin(sessionBean.getUsuarioLogado().getLogin());
//		
//		List<Desbravador> membros = new ArrayList<Desbravador>(); 
//				membros = dao.findAll();
//		if(!membros.isEmpty() && membros != null) {
//			GregorianCalendar data = new GregorianCalendar();
//			for(Desbravador d : membros){
//				if(d.getDataNascimento() != null){
//					data.setTime(d.getDataNascimento());
//					
//					if(d.verIdade() >= 16){
//						membros.add(d);
//					}
//				}
//			}
//			this.membrosAgrupadas = membros;
//			distrital.getClasseAgrupada().setMembros(membros);
//			
//			distDAO.beginTransaction();
//			distDAO.update(distrital);
//			distDAO.commit();
//		}
//		
...
//	Gets e Sets
	...
	public List<Desbravador> getMembrosAgrupadas() {
		return membrosAgrupadas;
	}
