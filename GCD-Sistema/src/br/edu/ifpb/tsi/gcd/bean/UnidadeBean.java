...
//	Metodos de LoginBean
	...
	public String addUnidade(){
		...
		}else if((daoUnid.findByName(nome.toUpperCase())) != null){
			sessionBean.addMensagem("Uma Unidade já existe com esse nome!", 1);
			
		}else{
			Clube clube = sessionBean.clube;
			
			Unidade u = new Unidade(nome.toUpperCase());
	...
	public String editarUnidade(){
		...
		}else if((dao.findByName(sessionBean.unidadeEditada.getNome().toUpperCase())) != null){
			sessionBean.addMensagem("Uma Unidade já existe com esse nome!", 1);
			return "page_editar_unidade?faces-redirect=true";
		}else{
