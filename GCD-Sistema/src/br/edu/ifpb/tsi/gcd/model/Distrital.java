...
public class Distrital extends Desbravador{
	...
	public Classe getClasseAgrupada() {
		return classeAgrupada;
	}

	public void setClasseAgrupada(Classe classeAgrupada) {
		this.classeAgrupada = classeAgrupada;
	}
